...
var FeedTree = function(o){
	...
	var $RSSfolder = $('<li class="open rss"><button class="toggle" name="toggle" value="toggle"></button><a href="#" style="cursor:default">GeoRSS-Feed</a><ul></ul></li>');
	$feedTree.append($RSSfolder);

	$addButton = $('<button class="add" name="addrss" value="addrss" title="neuen GeoRSS-Feed hinzufügen" style="cursor:pointer"></button>');
	$addButton.click(function(){
		$('<div ><input class="feedurl" /></div>').dialog({
			"title": "GeoRSS-Feed hinzufügen",
			"buttons":{
				"OK": function(){
