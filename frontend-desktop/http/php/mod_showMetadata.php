...
switch ($languageCode) {
	case "de":
		...
		$translation['resourceAbstract'] = 'Inhalt';
		...
		$translation['crs'] = 'angebotene Koordinatenreferenzsysteme';
		...
		$translation['mapbenderCapabilities'] = 'Geoport.HRO-Capabilities-Dokument';
		$translation['originalCapabilities'] = 'originales Capabilities-Dokument';
		...
		$translation['inspireCapabilities'] = 'INSPIRE-Capabilities-Dokument';
		...
		$translation['contactTelephone'] = 'Telefonnummer';
...
$html .= '<body>';
$metadataStr .= '<head>' . 
		'<title>Geoport.HRO – Metadaten</title>' . 
...
$capUrl = $resourceMetadata['wms_getcapabilities'].getConjunctionCharacter($resourceMetadata['wms_getcapabilities']).'REQUEST=GetCapabilities&VERSION=1.1.1&SERVICE=WMS';
	...
	$html .= $t_a.$translation['inspireMetadata'].$t_b."<a href='../php/mod_layerISOMetadata.php?SERVICE=WMS&outputFormat=iso19139&Id=".	$layerId."' target=_blank >Link zu den Metadaten</a>".$t_c;
	$html .= $t_a.$translation['inspireMetadataValidation'].$t_b."<a href='../php/mod_layerISOMetadata.php?SERVICE=WMS&outputFormat=iso19139&Id=".$layerId."&validate=true' target=_blank>".$translation['showInspireMetadataValidation']."</a>".$t_c;
	...
	//kml
	$html .= $t_a.$translation['kml'].$t_b."<a href='../php/mod_interfaceWms4Kml.php?id=".$layerId."'>KML herunterladen</a>".$t_c;
}
