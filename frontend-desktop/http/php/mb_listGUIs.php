...
function mb_listGUIs($arrayGUIs){
	...
	while($row = db_fetch_array($result)){
		...
		$divHtml .= "<li><div>".
					"<a onmouseover='style.color=\"#D81920\";' onmouseout='style.color=\"#006CB7\";' style='font-weight:bold;color:#006CB7;text-decoration:none' class='guiLink' href='".$url."'>".$row['gui_name']."</a></div>".
