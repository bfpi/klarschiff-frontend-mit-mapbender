...
try{
	...
	meetingPoint_image = "../img/button_digitize_blue_red/point_off.png";
}
...
function mod_meetingPoint_run(){   
	if (document.forms[0].mytext.value === "") {
		alert('Bitte geben Sie zuerst einen Text für Ihren Treffpunkt ein.');
		parent.mb_disableThisButton(mod_meetingPoint_button);
		return;
	}
	var mapObject = parent.getMapObjByName(mod_meetingPoint_target);
...
function checkMaxCharacters() {
	...
	if (stringLength > meetingPoint_max_characters) {
		...
		alert("Ihr Text wird zu lang: Er überschreitet bereits " + meetingPoint_max_characters + " Zeichen!");
	}
}

function setMaxCharacterTitle() {
	var maxCharacterString = "Eingabefeld für maximal " + meetingPoint_max_characters + " Zeichen";
...
<textarea class='strinput' rows="3" name='mytext' id='mytext' onmouseover='checkMaxCharacters()' title='' onkeyup='checkMaxCharacters()' style='font-family:Verdana;font-size:12px;width:230px;height:50px'></textarea>
<br><br>
<img  id='my_getCoords' name='my_getCoords' onclick="mod_meetingPoint_run()" onmouseover ="parent.mb_regButton_frame('init_mod_meetingPoint','meetingPoint',null)"  title="Treffpunkt auf Karte setzen"  src = '../img/button_digitize_blue_red/point_off.png'>
<br><br>
<input class="okbutton" name="Send" title="Treffpunkt erstellen"  type="button" value="erstellen" onclick="validate();" style="cursor:pointer;font-weight:bold;font-size:11px;font-family:Verdana;color:black;width:100px">
<br>
