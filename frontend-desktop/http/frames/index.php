...
$description = "";
$seitentitel = "";
if (substr($gui_id,0,strlen("Klarschiff")) == "Klarschiff") {
  $keywords = "Portal,Bürgerbeteiligung,Karte,Probleme,Ideen,Verwaltung";
  $description = "Klarschiff: Portal zur Bürgerbeteiligung. Melden Sie via Karte Probleme und Ideen im öffentlichen Raum, die dann von einer kommunalen Verwaltung bearbeitet werden.";
  $seitentitel = "Klarschiff – Portal zur Bürgerbeteiligung – Frontend";
}
else {
  $seitentitel = $gui_id;
}
...
while($row = db_fetch_array($res)){
  echo "<link rel=\"shortcut icon\" type=\"image/x-icon\" href=\"".$row["var_value"]."\">\n";
}
?> 
<?php
// reset CSS
